...
ret, bw_img = cv2.threshold(gray1, 127, 255, cv2.THRESH_BINARY)
  
# converting to its binary form
bw = cv2.threshold(gray1, 255, 255, cv2.THRESH_BINARY)
plt.subplot(339),plt.imshow(bw_img),plt.title('potholes')
plt.xticks([]), plt.yticks([])
